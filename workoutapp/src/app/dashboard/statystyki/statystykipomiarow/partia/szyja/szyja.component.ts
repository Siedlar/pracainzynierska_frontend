...
@Component({
  selector: 'app-szyja',
  templateUrl: './szyja.component.html',
  styleUrls: ['./szyja.component.css']
})
export class SzyjaComponent implements OnInit {
    ...
    this.pomiary.getPomiary().subscribe(
      data=>{
        ...
        data.forEach(element => {
          if(element.szyja !== 0){
            let i: number=0;
            this.lineChartData[i].data.push(element.szyja);
