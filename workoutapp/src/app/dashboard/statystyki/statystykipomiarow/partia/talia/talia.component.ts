...
@Component({
  selector: 'app-talia',
  templateUrl: './talia.component.html',
  styleUrls: ['./talia.component.css']
})
export class TaliaComponent implements OnInit {
    ...
    this.pomiary.getPomiary().subscribe(
      data=>{
        ...
        data.forEach(element => {
          if(element.talia !== 0){
            let i: number=0;
            this.lineChartData[i].data.push(element.talia);
