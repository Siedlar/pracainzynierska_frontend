...
@Component({
  selector: 'app-klatka',
  templateUrl: './klatka.component.html',
  styleUrls: ['./klatka.component.css']
})
export class KlatkaComponent implements OnInit {
    ...
    this.pomiary.getPomiary().subscribe(
      data=>{
        ...
        data.forEach(element => {
          if(element.klatka !== 0){
            let i: number=0;
            this.lineChartData[i].data.push(element.klatka);
